...
const Homepage = () => {
    ...
    return (
        <div className='bg-black'>
            ...
            <div className='bg-cover h-screen bg-center md:bg-cover w-full mb-40 md:h-screen bg-no-repeat  ' style={{ backgroundImage: `linear-gradient(to bottom, black, rgba(255,0,0,0)),URL(${img})` }}>
                <Type></Type>
            </div>
            <div id='work'>
